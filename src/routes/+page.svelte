...
<div class="min-h-screen bg-gradient-to-b from-base-200 to-base-300 pb-20">
  <div class="hero py-12 px-4 sm:px-6 lg:px-8 text-center">
      <div class="max-w-3xl mx-auto">
          <h1 class="text-5xl font-extrabold text-base-content mb-4">مدير كلمات المرور</h1>
          <p class="text-xl text-base-content/80">قم بتخزين وإدارة جميع كلمات المرور الخاصة بك بأمان في مكان واحد.</p>
      </div>
  </div>
              ...
              {#if activeTab === 'passwords'}
                  <div class="flex justify-between items-center mb-6">
                      ...
                      <p class="text-base-content/70">
                          إجمالي كلمات المرور: <span class="font-bold text-primary">{$filteredPasswords.length}</span>
                      </p>
                  </div>
